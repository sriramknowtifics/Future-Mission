...
<div class="rts-banner-area rts-section-gap pt_sm--20">
 ...
 <section class="rts-grocery-feature-area rts-section-gapBottom bg_light-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="title-area-between">
                    ...
                    <div class="next-prev-swiper-wrapper">
                        <div class="swiper-button-prev prod-prev"><i class="fa-regular fa-chevron-left"></i></div>
                        <div class="swiper-button-next prod-next"><i class="fa-regular fa-chevron-right"></i></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="category-area-main-wrapper-one">
                    <div class="swiper mySwiper-featured-grocery swiper-data" data-swiper='{
                        "spaceBetween": 24,
                        "slidesPerView": 6,
                        "loop": true,
                        "speed": 1000,
                        ...
                        <div class="swiper-wrapper">
                            ...
                            @forelse($featured as $product)
                                ...
                                <div class="swiper-slide">
                                    <div class="single-grocery-product-one">
                                        <!-- Discount Badge -->
                                        <div class="discount">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="unit text-muted">Stock unit</p>
                                            ...
                                            <div class="price">
                                                ...
                                                <del class="text-muted ms-2">₹{{ number_format($oldPrice, 2) }}</del>
                                            </div>

                                            <!-- Quantity + Add Button - LEFT ALIGNED -->
                                            <div class="cart-area d-flex align-items-center gap-3 mt-3">
                                                ...
                                                <form action="{{ route('cart.add') }}" method="POST" class="m-0">
                                                    ...
                                                    <input type="hidden" name="quantity" class="cart-quantity-input" value="1">
...
<section class="rts-grocery-feature-area rts-section-gapBottom bg_light-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="title-area-between">
                    <h2 class="title-left">Featured Services</h2>
                    <div class="next-prev-swiper-wrapper">
