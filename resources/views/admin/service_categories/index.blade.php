...
<div class="d-flex justify-content-between align-items-center my-4">
    ...
    <a href="{{ route('admin.service_categories.create') }}" class="btn btn-primary btn-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{-- EDIT --}}
                        <a href="{{ route('admin.service_categories.edit', $cat->id) }}"
                        ...
                        {{-- DELETE --}}
                        <form
                            action="{{ route('admin.service_categories.destroy', $cat->id) }}"
                            method="POST"
                            class="d-inline"
